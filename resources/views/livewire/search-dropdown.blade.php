					...
					<div class="absolute top-0">
						<svg 
							class="fill-current w-4 text-gray-500 mt-2 ml-2"
		 					...
		 					class="heroicon-ui" d="M16.32 14.9l5.39 5.4a1 1 0 01-1.42 1.4l-5.38-5.38a8 8 0 111.41-1.41zM10 16a6 6 0 100-12 6 6 0 000 12z"/>
						</svg>
					</div>
				<div 
					wire:loading class="spinner top-0 right-0 mr-4 mt-4">
				</div>
				...
				@keydown.escape.window="isOpen = false">
					...
					<ul>
						...
						@if ($result['poster_path'])
							<img 
							src="https://image.tmdb.org/t/p/w92/{{ $result['poster_path'] }}" alt="poster" 
							class="w-8">
						@else
